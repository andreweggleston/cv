...
\cvsection[resume-sidebar]{Work Experience}
  ...
  \cveventnew{\href{https://www.genelec.com}{Genelec Inc.}}{Shipping and Tech}{Designed systems for routing audio and video from production to editing. Maintained network architecture using \textbf{Dante} protocol. Configured SSL mixing console \& speakers with DHCP server.}{March 2020 - Present}{Natick, MA}
