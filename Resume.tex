...
\cvsection{Projects}
  ...
  A web application designed to view Dota 2 replays. Replays consist of network packets from all players. \textbf{Observer} translates this network data into meaningful information such as player location and state. Written in \textbf{Go}, frontend with \textbf{React}.
  \divider
