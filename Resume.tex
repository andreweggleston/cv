...
\cvsection[resume-sidebar]{Work Experience}
  ...
  \cveventnew{\href{https://www.genelec.com}{Genelec Inc.}}{Technician}{Created a paperless online system for sending purchase orders to  shipping. Updated network architecture to support \textbf{Dante} networking protocol with DHCP. Tested software which managed DSP calibration hardware installed in speakers.}{March 2020 - Present}{Natick, MA}
