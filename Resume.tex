...
\cvsection[resume-sidebar]{Work Experience}
  ...
  \cveventnew{\href{https://www.genelec.com}{Genelec Inc.}}{Technician}{Designed systems for routing audio and video from production to editing. Created network architecture using \textbf{Dante} protocol and DHCP. Created \& tested software which managed DSP calibration hardware installed in speakers.}{March 2020 - Present}{Natick, MA}
